...
class FormValidation {
  ...
  # Methods - Functions for validating
    ...
    //STRING ONLY - Required Field Validation No Spaces!
  public function validateRequiredStringField($inputValue) {
  if(trim($inputValue) == '' || !strcasecmp($inputValue, "null") || !strcasecmp($inputValue, "undefined") || preg_match('/[^a-zA-Z\d\s.,]/', $inputValue) || preg_match('/\s+/', $inputValue)) {
      return false;
    }
    else {
      return true;
  ...
  public function validateRequiredTextArea($inputValue) {
  if(trim($inputValue) == '' || !strcasecmp($inputValue, "null") || !strcasecmp($inputValue, "undefined") || preg_match('/[^a-zA-Z\d\s.,]/', $inputValue)) {
      return false;
    }
    else {
      return true;
  ...
  public function charactersRequired($inputValue, $amount) {
